package io.syspulse.edisko.server.core.auth

import java.util.UUID

import io.syspulse.edisko.server.BaseServiceTest
import io.syspulse.edisko.server.core.AuthData
import io.syspulse.edisko.server.core.auth.{AuthDataStorage, InMemoryAuthDataStorage, JdbcAuthDataStorage}
import io.syspulse.edisko.server.utils.InMemoryPostgresStorage
