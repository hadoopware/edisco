...
package object core {
  ...
  final case class TranslatePost(text: Option[String] = None, fromLang:Option[String]=None, toLang:Option[String]=None)
  final case class TranslateResponse(text: String, translated:String, id:String)
}
